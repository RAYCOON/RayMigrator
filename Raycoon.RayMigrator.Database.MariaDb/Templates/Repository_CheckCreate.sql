...
TableBaseName = "Table name prefix from Repository configuration - MUST be lowercase for MariaDB (DAL-018)"
...
Note5 = "MariaDB DDL causes implicit commit - tables are created individually with IF NOT EXISTS"

...
Note5 = "No IF/THEN/ELSE outside stored procedures - uses conditional WHERE clauses instead"
================================================================================
*/

SET @v_existing_id = @ExistingMigrationId;
...
SET @v_migration_id = CASE WHEN @v_updated > 0 THEN @v_existing_id ELSE LAST_INSERT_ID() END;

SELECT CONCAT(
    CAST(@v_migration_id AS CHAR),
    ',Migration record with Id [', CAST(@v_migration_id AS CHAR), '] successfully ',

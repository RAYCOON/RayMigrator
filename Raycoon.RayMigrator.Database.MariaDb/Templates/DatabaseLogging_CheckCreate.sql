...
TableBaseName = "Table name prefix from Logging configuration - MUST be lowercase for MariaDB (DAL-018)"
...
Note6 = "MariaDB DDL causes implicit commit - no explicit transaction wrapping"

...
namespace Raycoon.RayMigrator.Database.MariaDb;

[DatabaseType("MariaDb")]
public class DalMariaDb : DalBase, IDal
{
    private readonly string _connectionString;
    public override string DatabaseType { get; }
    public override DalSpecificProperties DalSpecificProperties { get; }

    public DalMariaDb(string connectionString)
    {
    ...
    // Transient MariaDB error codes that trigger automatic retry.
    ...
    /// AllowUserVariables: Required because MariaDB templates use session variables (@v_count, @dummy, etc.).
    /// </summary>
    ...
    /// Required because MariaDB templates use session variables (@v_count, @dummy) alongside

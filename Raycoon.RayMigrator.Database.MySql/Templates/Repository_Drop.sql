...
DROP TABLE IF EXISTS {CFG:TableBaseName}migration_log;
DROP TABLE IF EXISTS {CFG:TableBaseName}migration_event;
DROP TABLE IF EXISTS {CFG:TableBaseName}migration_record_history;
DROP TABLE IF EXISTS {CFG:TableBaseName}migration_record;
DROP TABLE IF EXISTS {CFG:TableBaseName}migration_run_meta;
DROP TABLE IF EXISTS {CFG:TableBaseName}migration_run;
DROP TABLE IF EXISTS {CFG:TableBaseName}product;
DROP TABLE IF EXISTS {CFG:TableBaseName}environment;
DROP TABLE IF EXISTS {CFG:TableBaseName}migrator_meta;
DROP TABLE IF EXISTS {CFG:TableBaseName}migration_run_mode;
DROP TABLE IF EXISTS {CFG:TableBaseName}migration_run_result;
DROP TABLE IF EXISTS {CFG:TableBaseName}migration_operation;
DROP TABLE IF EXISTS {CFG:TableBaseName}migration_status;

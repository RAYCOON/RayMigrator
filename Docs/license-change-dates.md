...
|---------|----------------|---------------------------|-------------|----------------|
| 0.15.0  | BUSL-1.1 + Additional Use Grant (unchanged from 0.11.0) | **2026-09-23** (source; pushed to the public repository) | **2030-09-23** | Apache License 2.0 |
...
**0.15.0** — same licence regime and Additional Use Grant as 0.11.0; only the
...
2026-09-23; the GitHub binary release (tag `v0.15.0`) and the NuGet listing
...
*Licensed Work* version in the Parameters block changed. First public
distribution was the **source**, pushed to the public repository on
2026-09-09; the GitHub binary release (tag `v0.13.0`) and the NuGet listing
followed the same day.

**0.12.0** — same licence regime and Additional Use Grant as 0.11.0; only the
*Licensed Work* version in the Parameters block changed. First public
distribution was the **source**, pushed to the public repository on
2026-09-08; the GitHub binary release (tag `v0.12.0`) and the NuGet listing
followed the same day.

**0.11.1** — same licence regime and Additional Use Grant as 0.11.0; only the
*Licensed Work* version in the Parameters block changed. First public
distribution was the **source**, pushed to the public repository on
2026-09-05; the GitHub binary release (tag `v0.11.1`) followed the same day.

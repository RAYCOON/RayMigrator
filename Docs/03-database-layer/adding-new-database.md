...
- Quick start using the `Database.Example` skeleton project (22 placeholder templates: 21 required by the engine + `Repository_MigrationRecordHistory_Archive.sql`)
...
- All 21 SQL templates required by the engine, with placeholder and result conventions

...
The project contains approximately **1280+ unit test cases** organized into **103 test classes** across **66 source test files** using a **P0-P3 priority system** (each file may contain multiple related test classes):

- **P0** — Critical parsing and core behavior (9 files, 15 classes)
- **P1** — Business logic and configuration (45 files, 63 classes)
- **P2** — Secondary features and utilities (10 files, 18 classes)
- **P3** — Models and exceptions (2 files, 6 classes)
...
A separate **ConfigWizard.Core unit test project** (`Raycoon.RayMigrator.Tests.Unit.ConfigWizard.Core`) contains approximately **460+ tests** across **27 test classes** in **27 files**, covering the zero-dependency shared domain library:
...
A separate **ConfigWizard.Web unit test project** (`Raycoon.RayMigrator.Tests.Unit.ConfigWizard.Web`) contains approximately **270+ tests** across **5 test classes** covering service classes of the Blazor WASM standalone configuration wizard:
...
| `P2_MigrationIdLoggingPipelineTests` | `MigrationIdLoggingPipelineTests` | Migration ID enrichment in Serilog log context |
...
| FluentAssertions 8.9.0 | Fluent assertion syntax (used in some test classes) |
| NSubstitute 5.3.0 | Mocking framework |
| Microsoft.NET.Test.Sdk 18.3.0 | Test runner integration |
| Microsoft.Extensions.Configuration 10.0.5 | Configuration support |
| Microsoft.Extensions.Configuration.Json 10.0.5 | JSON configuration file support |

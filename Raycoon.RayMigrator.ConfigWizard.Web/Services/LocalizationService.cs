...
public class LocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
    {
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["Welcome.MaturityNotice"] = "RayMigrator 0.11.x is a pre-1.0 release, not yet proven across a broad range of production workloads. Database migrations are inherently irreversible — use this version only where a failed migration would not have far-reaching consequences, and always back up first.",
            ["Footer.Imprint"] = "Legal Notice",
            ["Footer.Privacy"] = "Privacy",
            ["Footer.Terms"] = "Terms of Use",
            ["Footer.ImprintUrl"] = "https://raymigrator.com/en/legal-notice",
            ["Footer.PrivacyUrl"] = "https://raymigrator.com/en/privacy",
            ["Footer.TermsUrl"] = "https://raymigrator.com/en/terms-of-use",
            ["Terms.DialogTitle"] = "Terms of Use",
            ["Terms.DialogIntro"] = "Downloading the configuration requires acceptance of the Config Wizard Terms of Use. The key points:",
            ["Terms.PointDraft"] = "The generated configuration is a draft, based solely on your input.",
            ["Terms.PointReview"] = "Review connection strings, target assignments, and rollback settings before running any migration.",
            ["Terms.PointBackup"] = "Take a verified, restorable backup of every affected database before migrating.",
            ["Terms.ReadFull"] = "Read the full Terms of Use",
            ["Terms.AcceptCheckbox"] = "I have read and accept the Terms of Use.",
            ["Terms.AcceptAndDownload"] = "Accept & download",
            ["Terms.NoteIncluded"] = "An acceptance note (timestamp, terms version) is included in the exported ZIP file. It stays with you — nothing is transmitted.",
            ...
            ["Phase3.ExportWarning"] = "The generated configuration is a draft. Review connection strings, target assignments, and rollback settings before running any migration — and take a verified, restorable backup of every affected database first.",
        ...
        ["de"] = new Dictionary<string, string>
        {
            ...
            ["Welcome.MaturityNotice"] = "RayMigrator 0.11.x ist eine Pre-1.0-Version und noch nicht über eine breite Palette von Produktionsumgebungen hinweg erprobt. Datenbankmigrationen sind ihrer Natur nach unumkehrbar — setzen Sie diese Version nur dort ein, wo eine fehlgeschlagene Migration keine weitreichenden Folgen hätte, und sichern Sie vorher immer.",
            ["Footer.Imprint"] = "Impressum",
            ["Footer.Privacy"] = "Datenschutz",
            ["Footer.Terms"] = "Nutzungsbedingungen",
            ["Footer.ImprintUrl"] = "https://raymigrator.com/de/impressum",
            ["Footer.PrivacyUrl"] = "https://raymigrator.com/de/datenschutz",
            ["Footer.TermsUrl"] = "https://raymigrator.com/de/nutzungsbedingungen",
            ["Terms.DialogTitle"] = "Nutzungsbedingungen",
            ["Terms.DialogIntro"] = "Der Download der Konfiguration setzt die Zustimmung zu den Nutzungsbedingungen des Config Wizard voraus. Die Kernpunkte:",
            ["Terms.PointDraft"] = "Die erzeugte Konfiguration ist ein Entwurf und beruht allein auf Ihren Eingaben.",
            ["Terms.PointReview"] = "Prüfen Sie Verbindungszeichenfolgen, Zielzuordnungen und Rollback-Einstellungen, bevor Sie eine Migration ausführen.",
            ["Terms.PointBackup"] = "Erstellen Sie vor jeder Migration eine verifizierte, wiederherstellbare Sicherung jeder betroffenen Datenbank.",
            ["Terms.ReadFull"] = "Nutzungsbedingungen im Volltext lesen",
            ["Terms.AcceptCheckbox"] = "Ich habe die Nutzungsbedingungen gelesen und akzeptiere sie.",
            ["Terms.AcceptAndDownload"] = "Akzeptieren & herunterladen",
            ["Terms.NoteIncluded"] = "Der exportierten ZIP-Datei wird ein Annahmevermerk (Zeitpunkt, Fassung) beigefügt. Er verbleibt bei Ihnen — es wird nichts übertragen.",
            ...
            ["Phase3.ExportWarning"] = "Die erzeugte Konfiguration ist ein Entwurf. Prüfen Sie Verbindungszeichenfolgen, Zielzuordnungen und Rollback-Einstellungen, bevor Sie eine Migration ausführen — und erstellen Sie zuvor eine verifizierte, wiederherstellbare Sicherung jeder betroffenen Datenbank.",

...
public class LocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
    {
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["Welcome.MaturityNotice"] = "RayMigrator 0.13.x is a pre-1.0 release, not yet proven across a broad range of production workloads. Database migrations are inherently irreversible — use this version only where a failed migration would not have far-reaching consequences, and always back up first.",

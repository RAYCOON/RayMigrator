...
public class PostgreSqlCliToolFileTests : PostgreSqlTestBase
{
    public PostgreSqlCliToolFileTests(PostgreSqlFixture fixture) : base(fixture) { }
    ...
    public async Task HappyPath_FileMode_AllReleasesMigrated()
    {
        ...
        var cfg = CliToolConfigHelper.GetFileConfig("PostgreSQL", Fixture.EngineConfig.ConnectionString);

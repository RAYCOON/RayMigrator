...
public class MySqlCliToolDockerTests : MySqlTestBase
{
    private const string TableName = "clitest_mysql";

    public MySqlCliToolDockerTests(MySqlFixture fixture) : base(fixture) { }

...
public class MySqlCliToolFileTests : MySqlTestBase
{
    public MySqlCliToolFileTests(MySqlFixture fixture) : base(fixture) { }
    ...
    public async Task HappyPath_FileMode_AllReleasesMigrated()
    {
        ...
        var cfg = CliToolConfigHelper.GetFileConfig("MySql", Fixture.EngineConfig.ConnectionString);

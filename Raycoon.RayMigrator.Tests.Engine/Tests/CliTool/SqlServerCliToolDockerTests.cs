...
public class SqlServerCliToolDockerTests : SqlServerTestBase
{
    private const string TableName = "clitest_sqlserver";

    public SqlServerCliToolDockerTests(SqlServerFixture fixture) : base(fixture) { }
    ...
    public async Task DockerExec_CreateTableAndInsert_DataExists()
    {
        ...
        var createAndInsertSql =
            $"CREATE TABLE {TableName} (Id INT IDENTITY(1,1) PRIMARY KEY, Name NVARCHAR(100));\n" +

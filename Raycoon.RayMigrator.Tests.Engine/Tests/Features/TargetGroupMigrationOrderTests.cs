...
public class TargetGroupMigrationOrderTests : PostgreSqlTestBase
{
    public TargetGroupMigrationOrderTests(PostgreSqlFixture fixture) : base(fixture) { }

    /// <summary>
    /// Copies PostgreSQL_Frontend migration files into the work directory so the engine
    ...
    private static void CopyFrontendFiles(string workDir)
    {
        string frontendBase = Path.Combine(
            AppContext.BaseDirectory, "MigrationFiles", "PostgreSQL_Frontend");

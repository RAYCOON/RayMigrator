...
[Trait("Database", "MariaDb")]
[Trait("Category", "Features")]
public class MariaDbTargetGroupMigrationOrderTests : MariaDbTestBase
{
    public MariaDbTargetGroupMigrationOrderTests(MariaDbFixture fixture) : base(fixture) { }

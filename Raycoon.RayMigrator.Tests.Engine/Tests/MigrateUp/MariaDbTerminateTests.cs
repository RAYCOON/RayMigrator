...
public class MariaDbTerminateTests : MariaDbTestBase
{
    public MariaDbTerminateTests(MariaDbFixture fixture) : base(fixture) { }
    ...
    public async Task ErrorInLastFile()
    {
        ...
        // Seed data for tableg is missing (INSERT rolled back by transaction on MariaDB)

...
public class MariaDbRunAlwaysTests : MariaDbTestBase
{
    public MariaDbRunAlwaysTests(MariaDbFixture fixture) : base(fixture) { }
    ...
    public async Task RunAlways_FailsOnRerun_Terminate()
    {
        ...
        File.WriteAllText(seedPath,
            ...
            */
            ...
            INSERT INTO tablea (id, name, value) VALUES (999, 'runalways_test', 10);
            """);

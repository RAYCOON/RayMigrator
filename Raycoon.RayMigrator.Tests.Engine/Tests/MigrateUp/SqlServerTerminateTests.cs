...
public class SqlServerTerminateTests : SqlServerTestBase
{
    public SqlServerTerminateTests(SqlServerFixture fixture) : base(fixture) { }
    ...
    public async Task ErrorInLastFile()
    {
        ...
        // Seed data for TableG is missing (INSERT rolled back by transaction on SQL Server)

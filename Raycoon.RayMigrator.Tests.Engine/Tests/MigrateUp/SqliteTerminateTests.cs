...
public class SqliteTerminateTests : SqliteTestBase
{
    public SqliteTerminateTests(SqliteFixture fixture) : base(fixture) { }
    ...
    public async Task ErrorInLastFile()
    {
        ...
        // Seed data for tableg is missing (INSERT rolled back by transaction on SQLite)

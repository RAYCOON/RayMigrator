...
public class MySqlTerminateTests : MySqlTestBase
{
    public MySqlTerminateTests(MySqlFixture fixture) : base(fixture) { }
    ...
    public async Task ErrorInLastFile()
    {
        ...
        // Seed data for tableg is missing (INSERT failed on MySQL)
